...
import 'package:school_management/Screens/Help.dart';
import 'package:school_management/Screens/Leave_Apply/Leave_apply.dart';
import 'package:school_management/Screens/Activities/Activities.dart';
import 'package:school_management/Screens/Notifs.dart';
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        ...
        DrawerListTile(imgpath: "footy.png", name: "Activity",  ontap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
        ...
        DrawerListTile(imgpath: "feedback.png", name: "Feedback",  ontap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (BuildContext context) => LeaveApply(),
        ...
        DrawerListTile(imgpath: "help.png", name: "Help",  ontap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
